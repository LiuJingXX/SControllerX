...
public interface BleConnectionApi extends GenericConnectionApi<String> {
    ...
    ///////////////////////////////////////////////////////////////////////////
    @Override
    NetworkNodeBleConnection connect(@NonNull String address,
                                     @NonNull ConnectPriority connectPriority,
                                     @NonNull Action1<NetworkNodeConnection> onConnectedCallback,
    ...
    ///////////////////////////////////////////////////////////////////////////
    void onSessionError(@NonNull String bleAddress, int errorCode);
     ...
     */
    boolean isClosedOrPending(@NonNull String bleAddress);
     ...
     */
    @NonNull
    ConnectionState getConnectionState(@NonNull String bleAddress);

    Boolean lastSessionSuccessful(@NonNull String bleAddress);
